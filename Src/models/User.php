 ...
 *
 * @property CardPair[] $cardPairs
 * @property Category[] $categories
 * @property LexicalGame[] $lexicalGames
 * @property MemoryGame[] $memoryGames
 */
class User extends ActiveRecord implements IdentityInterface {
    ...
    public function getCardPairs() {
        return $this->hasMany(CardPair::class, ['afp2_user_id' => 'id']);
    }
    ...
    public function getCategories() {
        return $this->hasMany(Category::class, ['afp2_user_id' => 'id']);
    }

    /**
     * @return ActiveQuery
     */
    public function getLexicalGames() {
        return $this->hasMany(LexicalGame::class, ['afp2_user_id' => 'id']);
    }

    /**
     * @return ActiveQuery
     */
    public function getMemoryGames() {
        return $this->hasMany(MemoryGame::class, ['afp2_user_id' => 'id']);
    }
